...
def test_filter_by_state_3(test_list_3):
    assert filter_by_state(test_list_3) == "В списке отсутствует нужный статус"
...
def test_sort_by_date_2(test_list_sort_date_2):
    assert sort_by_date(test_list_sort_date_2) == "Невернно введены данные"


def test_sort_by_date_3(test_list_sort_date_3):
    assert sort_by_date(test_list_sort_date_3) == "Отсутствуют даты"
